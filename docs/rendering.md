...
permalinks, and a **per-document colophon** (prev/next within an explicit `?series=`
family, publish date, size, and a link to the gallery) above a small **"Generated by demiplane"** footer.
